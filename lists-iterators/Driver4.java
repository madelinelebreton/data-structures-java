 ...
 * Driver for ArrayListQueue . Tests all the implemented methods, including error scenarios and 2 data types
 *
...
public class Driver4
{
    ...
    {
        QueueADT<Integer> myQueue = new ArrayListQueue<Integer>(); // create new queue of integers
        
        System.out.println("--------  TESTING ARRAY LIST QUEUE   --------");
        ...
        // create new queue for testing string datatype
        QueueADT<String> myStringQueue = new ArrayListQueue<>(); // create new queue of strings
