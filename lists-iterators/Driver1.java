 ...
 * Implements a stack using a java.util.LinkedList. Tests all the implemented methods, including error scenarios and 2 data types
 *
...
public class Driver1
{
    ...
    {
        StackADT<Integer> myStack = new LinkedListStack<Integer>(); // create new stack of integers
